...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->SetY(13);
        $this->Cell(0, 15, 'Hasil Tugas', 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
$mulai = strftime('%A, %d %B %Y', strtotime($tugas->tgl_mulai));
$selesai = strftime('%A, %d %B %Y', strtotime($tugas->terlambat));
