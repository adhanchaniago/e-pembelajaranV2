<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="pull-right">
            <a href="<?= base_url('tugas/add') ?>" class="btn bg-purple btn-sm btn-flat"><i class="fa fa-file-text-o"></i> Tugas Baru</a>
            <button type="button" onclick="reload_ajax()" class="btn btn-sm btn-flat bg-maroon"><i class="fa fa-refresh"></i> Reload</button>
        </div>
    </div>
    <?= form_open('tugas/delete', array('id' => 'bulk')) ?>
...
<script src="<?= base_url() ?>assets/dist/js/app/tugas/data.js"></script>