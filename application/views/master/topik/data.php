<div class="box">
	...
	<div class="box-body">
		<div class="mt-2 mb-3">
			...
			<a href="<?= base_url('topik/import') ?>" class="btn btn-sm btn-flat btn-success"><i class="fa fa-upload"></i> Import</a>
		...
		<table id="topik" class="w-100 table table-striped table-bordered table-hover">
			<thead>
				<tr>
					<th>No.</th>
					<th>Kelas</th>
...
<div class="modal fade" id="myModal">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<?= form_open('topik/add', array('id', 'tambah')); ?>
